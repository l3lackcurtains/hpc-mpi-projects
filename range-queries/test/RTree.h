...
// http://superliminal.com/sources/RTreeTemplate.zip I made a few minor
// modifications to remove compiler errors and warnings (see note below regarding
// windows) This code has been successfully compiled and tested using g++ v.4.4.7
// (Ubuntu) and v.5.4.0 (Red Hat) End note by Mike Gowanlock
